package com.nyfaria.growlight.network;
...
public class NetworkHandler {
    ...
    public static final SimpleChannel INSTANCE = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(GrowLight.MODID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        List<BiConsumer<SimpleChannel, Integer>> packets = ImmutableList.<BiConsumer<SimpleChannel, Integer>>builder()
                .add((channel, id) -> SimpleLevelCapabilityStatusPacket.register(LightHolderAttacher.LIGHT_RL, LightHolderAttacher::getExampleLightHolderUnwrap, channel, id))
                .build();
